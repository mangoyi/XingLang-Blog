...
(function (){
	...
	var s;
	//IE
	if((/msie ([\d.]+)/).test(ua)) {   //如果存在msie x.0,x.0的话
		s = ua.match(/msie ([\d.]+)/);  
		sys.ie = s[1];     //得到的是7.0,8.0,9.0,10.0        不能得到11.0因为已经发生变化了
	}
...
function offsetTop(element){
	...
	while(parent != null) {  //如果这个节点上面一直有父节点则一直无限循环上去
